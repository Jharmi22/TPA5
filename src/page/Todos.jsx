              ...
              <div className="col label">
                <div className="form-group">
                  <div className="input-group">
                    ...
                    <span className="input-group-btn">
                      <button className="btn btn-warning add ms-2" name="todo" type="button" onClick={() => handleedit(idedit)}>
                        Edit
                      </button>
                    </span>
                  </div>
        ...
        <div className="container">
          <div className="row label d-flex justify-content-between">
            <div>
              ...
              <button className={`btn add ms-2 ${selected === "Active" ? "btn-success add" : "btn add"}`} name="Active" type="button" onClick={handlepick}>
                Active
              </button>
